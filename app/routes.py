...
def home():
    ...
    facebook_page_url = "https://www.facebook.com/votre_page" # À remplacer
    instagram_username = "votre_instagram" # À remplacer
    ...
    <body class="bg-slate-900 text-white min-h-screen flex flex-col items-center justify-center p-6">
        <div class="max-w-3xl w-full text-center space-y-8 py-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                <a href="/qr-status" class="flex items-center justify-center gap-3 bg-white text-slate-900 font-bold py-4 px-6 rounded-2xl transition-all transform hover:scale-105 shadow-lg border-2 border-white">
                    <span class="text-2xl">📱</span>
                    Scanner le QR Code
                </a>
                <a href="https://wa.me/{whatsapp_number}" target="_blank" class="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 px-6 rounded-2xl transition-all transform hover:scale-105 shadow-lg">
                ...
                <a href="https://t.me/{telegram_bot_username}" target="_blank" class="flex items-center justify-center gap-3 bg-[#0088cc] hover:bg-[#0077b5] text-white font-bold py-4 px-6 rounded-2xl transition-all transform hover:scale-105 shadow-lg">
                ...
                <a href="{facebook_page_url}" target="_blank" class="flex items-center justify-center gap-3 bg-[#1877F2] hover:bg-[#166fe5] text-white font-bold py-4 px-6 rounded-2xl transition-all transform hover:scale-105 shadow-lg">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    Facebook
                </a>
                <a href="https://instagram.com/{instagram_username}" target="_blank" class="flex items-center justify-center gap-3 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] hover:opacity-90 text-white font-bold py-4 px-6 rounded-2xl transition-all transform hover:scale-105 shadow-lg">
